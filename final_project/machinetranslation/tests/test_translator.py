...
class TestEnglishToFrench(unittest.TestCase): 
    def testNullInput(self): 
        self.assertEqual(english_to_french(None), None) # test when null is given as input, output is null
...
class TestFrenchToEnglish(unittest.TestCase): 
    def testNullInput(self): 
        self.assertEqual(french_to_english(None), None) # test when null is given as input, output is null
